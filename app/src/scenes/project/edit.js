        ...
        <div className="bg-[#FFFFFF] pb-4 border border-[#E5EAEF] rounded-[16px]">
          ...
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              try {
                await api.put(`/project/${project[0]._id}`, editedValues);
                ...
                <div className="py-3 px-4">
                  <div className="flex gap-4 flex-wrap">
                    ...
                    <div className="w-full md:w-[260px] mt-2">
                      ...
                      <input
                        ...
                        name="lead"
                        value={values.lead}
                        onChange={(e) => setEditedValues({ ...editedValues, lead: e.target.value })}
                      />
                    </div>
                    <div className="w-full md:w-[260px] mt-2">
                  ...
                  <div className="flex gap-4 mt-3">
                    <div className="w-full md:w-[260px]">
                      ...
                      <input
                        ...
                        onChange={(e) => setEditedValues({ ...editedValues, budget_max_monthly: e.target.value })}
                      />
                    </div>
                    <div className="w-full md:w-[260px] ">
                      ...
                      <select
                        ...
                        onChange={(e) => setEditedValues({ ...editedValues, paymentCycle: e.target.value })}>
                        <option value=""></option>
                  ...
                  <div className="w-full mt-3">
                    ...
                    <textarea
                      ...
                      onChange={(e) => setEditedValues({ ...editedValues, description: e.target.value })}></textarea>
                  </div>
                  ...
                  <div className="w-full mt-3">
                    ...
                    <textarea
                      ...
                      onChange={(e) => setEditedValues({ ...editedValues, objective: e.target.value })}></textarea>
                  </div>
