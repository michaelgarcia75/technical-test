    ...
    <div className="authWrapper font-myfont">
      ...
      <Formik
        ...
        onSubmit={async (values, actions) => {
          try {
            values.role = "ADMIN";
            values.avatar = "https://cdn.s7.shopdisney.eu/is/image/DisneyStoreES/461063547282?fmt=jpeg&qlt=90&wid=652&hei=652&defaultImage=no-image-image_fr";
            ...
            if (e.code === "ORGANISATION_ALREADY_REGISTERED") {
              toast.error("Organisation already existing", e.code);
            } else {
